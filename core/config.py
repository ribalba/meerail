...
_SECTION_KEYS: dict[str, dict[str, str]] = {
    ...
    "server": {
        ...
        "llm_allow_private_hosts": "llm_allow_private_hosts",
        "llm_timeout_seconds": "llm_timeout_seconds",
        "llm_max_thread_chars": "llm_max_thread_chars",
        "llm_max_image_bytes": "llm_max_image_bytes",
        "llm_max_attachment_chars": "llm_max_attachment_chars",
